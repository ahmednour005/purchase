                                                            ...
                                                            <div class="col-7 col-sm-9">
                                                              <div class="tab-content" id="vert-tabs-tabContent">
                                                                ...
                                                                <div class="tab-pane fade" id="vert-tabs-mainGroup" role="tabpanel" aria-labelledby="vert-tabs-mainGroup-tab">
                                                                    <div class="roles">
                                                                  <label class="container">
                                                                        <input type="checkbox" name="permissions[]" {{$user->hasPermission('mainGroup_read') ? 'checked' : ''}} value="mainGroup_read">
                                                                        <span class="checkmark"></span>
                                                                        @lang('site.show')
                                                                    </label>
                                                                </div>
                                                                <div class="roles">
                                                                     <label class="container">
                                                                        <input type="checkbox" name="permissions[]" {{$user->hasPermission('mainGroup_create') ? 'checked' : ''}} value="mainGroup_create">
                                                                        <span class="checkmark"></span>
                                                                        @lang('site.add')
                                                                    </label>
                                                                </div>
                                                                <div class="roles">
                                                                     <label class="container">
                                                                        <input type="checkbox" name="permissions[]" {{$user->hasPermission('mainGroup_update') ? 'checked' : ''}} value="mainGroup_update">
                                                                        <span class="checkmark"></span>
                                                                        @lang('site.edit')
                                                                    </label>
                                                                </div>
                                                                <div class="roles">
                                                                    <label class="container">
                                                                        <input type="checkbox" name="permissions[]" {{$user->hasPermission('mainGroup_delete') ? 'checked' : ''}} value="mainGroup_delete">
                                                                        <span class="checkmark"></span>
                                                                        @lang('site.delete')
                                                                    </label>
                                                                </div>
